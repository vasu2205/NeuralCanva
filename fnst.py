...
class Learner():
    ...
    def __prepare_style_target(self, im_path, batch_size):
        ...
        style_target = tuple(gram_matrix(x) for x in self.fx.features)
...
def main():
    ...
    if args.train:
        ...
        loss_network = nn.Sequential(*list(loss_network.features)[:23])
        ...
        lrn = Learner(loss_network=loss_network,
                      ...
                      r_weight=REG_WEIGHT,
                      style_proportions=STYLE_PROPORTIONS,
